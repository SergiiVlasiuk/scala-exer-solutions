...
class SecretHandshakeTest extends FunSuite with Matchers {
  ...
  test("reverse all possible actions2") {
    SecretHandshake.commands(63) should be(List("jump", "close your eyes", "double blink", "wink"))
    SecretHandshake.commands(47) should be(List("wink", "double blink", "close your eyes", "jump"))
  }
