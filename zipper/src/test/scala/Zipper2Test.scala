...
class Zipper2Test extends FunSuite with Matchers {
  def empty[A]: Option[BinTree2[A]] = None

  def bt[A](v: A, l: Option[BinTree2[A]], r: Option[BinTree2[A]]): Option[BinTree2[A]] =
    Some(BinTree2(v, l, r))

  def leaf[A](v: A): Option[BinTree2[A]] =
    Some(BinTree2(v, None, None))

  val t1: BinTree2[Int] = BinTree2(1, bt(2, empty, leaf(3)), leaf(4))
  val t2: BinTree2[Int] = BinTree2(1, bt(5, empty, leaf(3)), leaf(4))
  val t3: BinTree2[Int] = BinTree2(1, bt(2, leaf(5), leaf(3)), leaf(4))
  val t4: BinTree2[Int] = BinTree2(1, leaf(2), leaf(4))
  ...
  test("setLeft with Some") {
    z.toTree(z.setLeft(Some(BinTree2(5, None, None)),
