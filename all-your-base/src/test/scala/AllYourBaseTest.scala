...
class AllYourBaseTest extends FunSuite with Matchers {
  ...
  test("oct to multiple decimal") {
    println(AllYourBase.rebase(8, List(6, 3, 5, 2, 6, 0), 10))
    AllYourBase.rebase(8, List(6, 3, 5, 2, 6, 0), 10) should be(Some(List(2, 1, 1, 6, 3, 2)))
    //    AllYourBase.rebase(8, List(6, 3, 5, 2, 6, 0), 10) should be(Some(List(4, 2)))
  }
