...
/** @version 2.2.0 */
class House3Test extends FunSuite with Matchers {

  test("verse one - the house that jack built") {
    House3.recite(1, 1) should be(
